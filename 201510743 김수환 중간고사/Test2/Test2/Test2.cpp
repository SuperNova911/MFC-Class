...
// Test2.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CTest2App, CWinAppEx)
...
// CTest2App 사용자 지정 로드/저장 메서드

void CTest2App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTest2App::LoadCustomState()
{
}

void CTest2App::SaveCustomState()
{
}
