...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_paneHobby.Create(TEXT("문자열 출력"), this, CRect(0, 0, 260, 400), true, 911,
		WS_CHILD | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | CBRS_RIGHT | CBRS_FLOAT_MULTI))
	{
		TRACE0("도킹 팬을 만들지 못했습니다.");
		return -1;
	}

	m_paneHobby.SetMinSize(250);
	m_paneHobby.EnableDocking(CBRS_ALIGN_ANY);
	DockPane(&m_paneHobby);
