...
BEGIN_MESSAGE_MAP(CPractice7_2Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_CHECK_EXPAND, &CPractice7_2Dlg::OnClickedCheckExpand)
END_MESSAGE_MAP()


// CPractice7_2Dlg 메시지 처리기
...
BOOL CPractice7_2Dlg::OnInitDialog()
{
	...
	m_hRoot = m_treeControl.InsertItem(TEXT("루트 노드"), 0, TVI_LAST);
...
void CPractice7_2Dlg::OnClickedButtonDelete()
{
	if (m_hSelectedNode != m_hRoot)
	{
		if (MessageBox(TEXT("정말 삭제하시겠습니까?"), TEXT("삭제 경고"), MB_YESNO) == IDYES)
		{
...
void CPractice7_2Dlg::OnClickedCheckExpand()
{
