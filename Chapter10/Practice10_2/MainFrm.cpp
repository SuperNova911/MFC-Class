...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftViewDlg), CSize(300, 300), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CPractice10_2View), CSize(600, 300), pContext);
